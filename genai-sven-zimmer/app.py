...
with gr.Blocks(
    ...
    gr.Markdown(
            """
            > - "Zeige mir die Verkäufe der separaten Produktkategorien im letzten Jahr"
            > - "Vergleiche die Umsätze 2024 zwischen  Deutschland und Frankreich"
            > - "Wie haben sich die Mountain Bike Verkäufe über die letzten 6 Monate entwickelt?"
            """,
            elem_id="examples" 
        )
